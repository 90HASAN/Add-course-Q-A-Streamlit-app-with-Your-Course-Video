...
# ---------- Cached resources (loaded once, reused across every user question) ----------
...
def youtube_link(video_number, start_seconds):
    raw = VIDEO_ID_MAP.get(video_number)
...
if "history" not in st.session_state:
    st.session_state.history = []  # list of (question, answer, top_chunks)
